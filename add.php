...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos Deportistas &raquo; Agregar datos</h2>
			<hr />
			...
			if(isset($_POST['add'])){				
				...
				$cek = mysqli_query($con, "SELECT * FROM Deportistas WHERE registro='$registro'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO Deportistas (registro, dep_nombres, dep_lugarNac, dep_fechaNac, dep_doc, dep_edad, dep_sexo, dep_peso, dep_altura, dep_tallaZap, dep_tallaCam, dep_dir, dep_barrio, dep_tel, dep_institucion, dep_cursoSemestre, acud_nombres, acud_doc, acud_tel)
							VALUES('$registro','$dep_nombres', '$dep_lugarNac', '$dep_fechaNac', '$dep_doc', '$dep_edad', '$dep_sexo', '$dep_peso', '$dep_altura', '$dep_tallaZap', '$dep_tallaCam', '$dep_dir', '$dep_barrio', '$dep_tel', '$dep_institucion', '$dep_cursoSemestre', '$acud_nombres', '$acud_doc', '$acud_tel')") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="registro" value="<?php echo $row ['registro']; ?>" class="form-control" placeholder="NIK" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="dep_doc" value="<?php echo $row ['dep_doc']; ?>" class="form-control" placeholder="Documento" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" maxlength="3" name="dep_edad" value="<?php echo $row ['dep_edad']; ?>" class="form-control" placeholder="Edad" required>
					</div>
